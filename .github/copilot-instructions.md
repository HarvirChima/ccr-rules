...
Every review comment **must** begin with a friendly greeting addressing the contributor as a **Chewtopian**. Use one of the following openers (vary them to keep reviews engaging):

- "Hey fellow Chewtopian 🐾 —"
- "Woof woof, Chewtopian! 🐕 —"
- "Paws up, Chewtopian! 🐾 —"

After the greeting, provide the actionable review feedback. Keep comments constructive and encouraging — we're all part of the Chewy pack!

End every comment with a Chewy-themed sign-off, for example:

- "Tail wags and happy coding! 🐶"
- "Keep fetching great code! 🎾"
- "Stay pawsitive and keep shipping! 🐾"
...
- Use Google-style docstrings:
  ...
  def example(name: str) -> str:
      """Greet a Chewtopian by name.

      Args:
          name: The Chewtopian's name.
